    ...
    {   
        ...
        { 
            { 
                    ...
                    $undian = array();
                    $query3 = "SELECT namatim FROM (SELECT namatim, id FROM tim)
                              AS a INNER JOIN undian ON undian.idtim = a.id ORDER BY nomor ASC";
                ...
                <div class="row">
                    ...
                    <a href="admin_jadwal.php?jadwal=1" class="btn btn-primary btn-lg pull-right" role="button">Lihat Jadwal</a><br><br><br>
                        <table class="responstable">
                            <tr>
        ...
        else
        {
            require_once("../koneksi.php");
                    $tim = array();
                    $query = "SELECT namatim FROM (SELECT namatim, id FROM tim)
                              AS a INNER JOIN undian ON undian.idtim = a.id ORDER BY nomor ASC";
        ...
        <div class="row">
                    ...
                    <div class="col-xs-4 col-sm-6">
                    <a href="admin_jadwal.php" class="btn btn-primary btn-lg pull-right" role="button">Hasil Undian</a><br><br><br>
                        <table class="responstable">
                            <tr>
