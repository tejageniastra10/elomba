...
<head>
    ...
    <title> Penyelenggara Kegiatan</title>
...
<?php
    ...
    $query=mysqli_query($konek, "SELECT idpemain FROM pemain");
    $pemain = mysqli_num_rows($query);

    $days = ceil((strtotime("6/22/2016") - time())/(60*60*24));
    $s='';
    if ($days!=1) {
     $s='s';
        }
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="admin_dashboard.php">Penyelenggara Kegiatan </a>
            </div>
            <!-- Top Menu Items -->
            <ul class="nav navbar-right top-nav">
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> Penyelenggara <b class="caret"></b></a>
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?=$jum;?>/16</div>
                                        <div>Tim Terdaftar</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="panel panel-green">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?=$pemain;?></div>
                                        <div>Pemain Terdaftar!</div>
                                    </div>
                                </div>
                            </div>
                            <a href="admin_list.php">
                        ...
                        <div class="panel panel-yellow">
                            <div class="panel-heading">
                                ...
                                <div class="col-xs-3">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?php echo $days. " day$s remaining !";?></div>
