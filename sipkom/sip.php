    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!--isi-->
            <center>
                <img src="himakom.png" style="width: 150px; margin: 0 auto">
                <img src="SIPKOM.png" style="width: 500px; margin: 0 auto">
                <img src="transistor.png" style="width: 150px; margin: 0 auto">
                <h2><b>SISTEM INFORMASI DAN PENDAFTARAN KOMPETISI</b></h2>
                <h2><b>PESERTA</b></h2>
            </center>
            <br>
            <br>
            <h3><p> 
                Sistem Informasi dan Pendaftaran Kompetisi (SIPKOM) merupakan sistem terintegrasi yang dapat digunakan oleh peserta kompetisi futsal untuk mendaftarkan tim dan anggota tim nya.</p>

            <p> SIPKOM juga memberikan kemudahan bagi panitia pelaksana dalam pengelolaan berkas-berkas peserta. SIPKOM juga memberikan fitur Mesin Undian untuk melakukan undian grup dan juga dapat langsung menampilkan jadwal pertandingan. </p></h3>
